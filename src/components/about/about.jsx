                ...
                <div className="about-right">
                    <div className="about-para">
                        <p>I am a Front-End Developer with a strong foundation in HTML, CSS, JavaScript, and React.js.
                            I have completed projects using Git and Bootstrap to enhance user experience and design quality.
                        </p>
                        <p>I am eager to leverage my technical skills and innovative mindset to contribute effectively to a dynamic development team.</p>
                    </div>
